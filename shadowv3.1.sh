...
${Purple}|${Font_default}${Red}Разработчик:${Yellow} Very Rare ${Purple}            ${Font_default}${Purple}|${Font_default}
${Purple}|${Font_default}${Red}Telegram:${Yellow} @very266 ${Purple}            ${Font_default}${Purple}|${Font_default}
